...
<div class="row d-flex justify-content-around">
    <c:forEach var="vente" items="${requestScope.listArticles}">
        <div class="card col-5 border-secondary mb-3 ">
            <div class="card-body">
                <h5 class="card-title"><a href="${pageContext.request.contextPath}/AfficherEnchereServlet?nom_article=${vente.nomArticle}&num_article=${vente.noArticle}" title="nom_article">${vente.nomArticle}</a><input type="hidden" id="numArticleVente" name="numArticleVente" value="${vente.noArticle}"> </h5>
